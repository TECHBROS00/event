...
function Dashboard() {
  ...
  return (
    <div>
      {userCourseList?<>
      <h2 className='text-[20px] font-medium'>My Enroll Courses</h2>
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 mt-5 gap-5'>
        {
      ...
      text-[20px] mt-20 text-gray-500'>
        <h2>You don't have Enrolled Courses..</h2>
      </div>}
